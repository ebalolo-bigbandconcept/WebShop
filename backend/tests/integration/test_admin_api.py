...
class TestAdminUserManagement:
    ...
    def test_list_users_with_admin(self, client, admin_auth_headers, admin_user, regular_user):
    ...
    def test_create_user_duplicate_email(self, client, admin_auth_headers, regular_user):
