...
from models import db, Devis, Clients, EnvelopeTracking
import json
import base64
...
class TestDocuSignWebhook:
    ...
    def test_webhook_with_json_payload(self, client, app, test_devis, test_client_record):
    ...
    def test_webhook_with_declined_status(self, client, test_devis):
        ...
        envelope = EnvelopeTracking(
            envelope_id="test-envelope-declined",
            devis_id=test_devis.id,
            status="sent"
        )
        db.session.add(envelope)
...
class TestDocuSignSendPDF:
    ...
    def test_send_pdf_success(self, mock_send, client, admin_auth_headers, test_client_record, test_devis):
    ...
    def test_send_pdf_no_file(self, client, admin_auth_headers, test_client_record, test_devis):
    ...
    def test_send_pdf_invalid_devis(self, client, admin_auth_headers, test_client_record):
...
class TestDocuSignService:
    ...
    def test_load_private_key_file_not_found(self):
        ...
        with patch.dict('os.environ', {'DOCUSIGN_PRIVATE_KEY_PATH': '/nonexistent/path.pem'}):
    ...
    def test_load_private_key_success(self, mock_isfile, mock_file):
        ...
        from services.docusign_service import load_private_key, _CACHED_PRIVATE_KEY
    ...
    def test_get_docusign_token_success(self, mock_api_client, mock_load_key):
        ...
        from services.docusign_service import get_docusign_token, DOCUSIGN_TOKEN_CACHE
    ...
    def test_get_signers_single(self):
        ...
        from services.docusign_service import get_signers, get_sign_here_tab
    ...
    def test_send_envelope_for_signing_success(self, mock_envelopes_api, mock_get_token, app):
...
class TestDocuSignWebhookHandler:
    ...
    def test_handle_webhook_completed(self, app, test_devis):
        ...
        envelope = EnvelopeTracking(
            envelope_id="test-env-completed",
            devis_id=test_devis.id,
            status="sent"
        )
        db.session.add(envelope)
