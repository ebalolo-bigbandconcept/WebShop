...
from models import DevisArticles, TauxTVA, Articles
...
class TestPDFGeneration:
    ...
    def test_get_devis_pdf_direct_scenario(self, client, auth_headers, test_devis, test_article):
    ...
    def test_get_devis_pdf_location_without_apport(self, client, auth_headers, test_devis, test_article):
    ...
    def test_get_devis_pdf_location_with_apport(self, client, auth_headers, test_devis, test_article):
    ...
    def test_get_devis_pdf_location_devis_no_contract(self, client, auth_headers, test_devis):
    ...
    def test_get_devis_pdf_with_zero_location_time(self, client, auth_headers, test_parameters, test_devis):
...
class TestScenarioSelection:
    ...
    def test_select_scenario_location_without_apport(self, client, auth_headers, test_devis):
    ...
    def test_select_scenario_location_with_apport(self, client, auth_headers, test_devis):
    ...
    def test_select_scenario_locked_after_first_selection(self, client, auth_headers, test_devis):
    ...
    def test_select_scenario_prevents_change_for_signed(self, client, auth_headers, test_devis):
...
class TestSignedDevisPDF:
    ...
    def test_get_unsigned_devis_pdf_doesnt_use_snapshot(self, client, auth_headers, test_devis):
...
class TestPDFEdgeCases:
    ...
    def test_pdf_generation_with_missing_vat_rate(self, client, auth_headers, test_devis, test_article):
    ...
    def test_pdf_generation_with_zero_articles(self, client, auth_headers, test_devis):
        ...
        from models import DevisArticles
        from models import db
    ...
    def test_pdf_generation_with_negative_montant_handling(self, client, auth_headers, test_devis):
    ...
    def test_pdf_header_filename(self, client, auth_headers, test_devis):
        ...
        assert response.status_code == 200
        assert f"devis_{test_devis.id}.pdf" in response.headers.get("Content-Disposition", "")

    def test_pdf_generation_multiple_vat_rates(self, client, auth_headers, test_devis, taux_tva_20):
        """Test PDF generation correctly aggregates multiple VAT rates"""
        from models import TauxTVA, DevisArticles, Articles
        from models import db
...
class TestPDFLocationDevis:
    ...
    def test_pdf_location_without_apport_calculation(self, client, auth_headers, test_devis, test_parameters):
    ...
    def test_pdf_location_with_apport_calculation(self, client, auth_headers, test_devis, test_parameters):
    ...
    def test_pdf_location_with_subscription_costs(self, client, auth_headers, test_devis, test_parameters):
...
class TestPDFWithRealWorldScenarios:
    ...
    def test_pdf_with_all_parameters_set(self, client, auth_headers, test_devis, test_parameters):
