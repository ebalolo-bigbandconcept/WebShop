...
class TestDevisDelete:
    ...
    def test_delete_devis_success(self, client, test_devis, auth_headers):
        ...
        response = client.delete(
            f'/api/devis/delete/{test_devis.id}',
...
class TestDevisScenario:
    ...
    def test_select_scenario_location_with_apport(self, client, test_devis, auth_headers):
...
class TestDevisCreationWithArticles:
    ...
    def test_create_devis_with_article(self, client, auth_headers, test_client_record, test_article, taux_tva_20):
...
class TestDevisRetrieval:
    ...
    def test_get_devis_by_id_with_auth(self, client, auth_headers, test_devis):
        ...
        response = client.get(
            f'/api/devis/info/{test_devis.id}',
            headers=auth_headers
        )
...
class TestDevisUpdateOperations:
    ...
    def test_update_devis_with_auth(self, client, auth_headers, test_devis, test_article, taux_tva_20):
